...
//            }
	...
	public MimeMessage createEmailForm(String email) throws MessagingException, UnsupportedEncodingException {
        // 코드를 생성합니다.
        authNum = createCode();
        String setFrom = "maytrip@gmail.com";	// 보내는 사람
        String toEmail = email;		// 받는 사람(값 받아옵니다.)
        String title = "Maytrip 비밀번호 변경을 위한 인증번호 전송";		// 메일 제목		
        ...
        msgOfEmail += "<h1> 안녕하세요 Maytrip 인증센터 입니다. </h1>";
        msgOfEmail += "<br>";
        ...
        msgOfEmail += "<h3 style='color:blue;'>비밀번호 변경을 위한 인증코드 입니다.</h3>";
